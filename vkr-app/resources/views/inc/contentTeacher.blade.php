...
<div class="container mt-1">
  ...
  <div class="row">
    ...
    <div class="col-2 mt-4">
      ...
      <button type="button" class="btn btn-lg btn-block btn-primary round-3">+ Добавить ВКР</button>
    </div>
            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                  ...
                  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path></svg> Удалить
                  </button></td>
